...
const tabs = [
  {
    name: PRODUCT.brandUpdates.plural,
    icon: TagLabelIcon,
    slug: PRODUCT.brandUpdates.dashSlug,
  },
  {
    name: PRODUCT.requests.plural,
    icon: FeedbackIcon,
    slug: PRODUCT.requests.dashSlug,
  },
  {
    name: PRODUCT.timeline.singular,
    icon: CalendarIcon,
    slug: PRODUCT.timeline.dashSlug,
  },
  {
    name: 'Analytics',
    icon: AnalyticsIcon,
